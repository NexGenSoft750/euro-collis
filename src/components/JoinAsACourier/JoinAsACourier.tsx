        ...
        <div className={styles.JoinAsACourier}>
            <div className='ps-10 md:ps-20 pt-10 pe-10 md:pe-0 flex items-center h-full'>
                <div className='flex-1 flex flex-col items-center md:items-start gap-7'>
                    ...
                    />
                    <p className='text-lg text-center md:text-left'>Earn money while traveling! Become a trusted Eurocollis courier and deliver packages between Morocco and Europe.</p>
                    <Button>
                        Sign Up as Courier
                    </Button>
                </div>
